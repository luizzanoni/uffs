...
public class App {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            pessoa1.setId(idPessoa);
            pessoa1.razaoSocial = razaoSocial;

            System.out.println("Seu ID e Usuário é:  " + pessoa1.getId() + " - " + pessoa1.razaoSocial);
            ...
            if (opcao == 0) {
                ...
                System.out.println("Sua Agência é: " + agencia1.getId() + " - " + agencia1.razaoSocialAgencia);
                ...
                System.out.println("O numero do seu cartão é: " + cartao1.getNumero() + " e ele vence dia: " + cartao1.dataValidade);
                ...
                if (opcao1 == 1) {
                    ...
                    System.out.print(agencia1.getId() + " - " + agencia1.razaoSocialAgencia);
                    scanner.nextLine();
                } else {
                    System.out.println("Obrigado por escolher nossos serviços " + pessoa1.razaoSocial);
                    break;
